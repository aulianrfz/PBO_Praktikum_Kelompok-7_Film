...
<head>
  ...
  <title>Web Personal Profile - Cravitae</title>
  ...
  <main id="main">
          ...
          <div class="container" data-aos="fade-up">
            ...
            <div class="row skills-content">
              ...
              <div class="col-lg-6">
                ...
                <div class="progress">
                  <span class="skill">PicsArt<i class="val">90%</i></span>
                  <div class="progress-bar-wrap">
                    <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Portfolio</h2>
          <p>Here is my portfolio, showcasing a selection of my work</p>
        </div>
...
<!-- 
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="copyright">
        &copy; Copyright 2023 <strong><span>Cravitae</span></strong>. All Rights Reserved
      </div>
      <!-- <div class="credits">
        Designed by <a href=".">Group 1 Web Personal Profile</a>
      </div> -->
    </div>
  </footer>
    <!-- End Footer -->
